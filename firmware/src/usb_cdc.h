 ...
 */
//
// Modified 27 Aug 2018 by Mark Haun for IAR compiler
//
...
__packed struct usb_cdc_header_desc {
...
__packed struct usb_cdc_union_desc {
...
__packed struct usb_cdc_country_desc {
    uint8_t     bFunctionLength;     /**<\brief Size of this functional descriptor, in bytes.*/
    uint8_t     bDescriptorType;     /**<\brief CS_INTERFACE descriptor type.*/
 ...
 * descriptor.*/
__packed struct usb_cdc_call_mgmt_desc {
    uint8_t     bFunctionLength;    /**<\brief Size of this functional descriptor, in bytes.*/
    uint8_t     bDescriptorType;    /**<\brief CS_INTERFACE descriptor type.*/
 ...
 * descriptor.*/
__packed struct usb_cdc_acm_desc {
    uint8_t     bFunctionLength;    /**<\brief Size of this functional descriptor, in bytes.*/
    uint8_t     bDescriptorType;    /**<\brief CS_INTERFACE descriptor type.*/
...
__packed struct usb_cdc_notification {
...
__packed struct usb_cdc_line_coding {
