...
__packed struct usb_header_descriptor {
...
__packed struct usb_iad_descriptor {
    uint8_t bLength;                /**<\brief Size of the descriptor, in bytes.*/
...
__packed struct usb_string_descriptor {
    ...
    char16_t wString[];             // mh: changed from uint16_t[]
                                    /**<\brief String data, as unicode characters or array of
 ...
 * endpoint number.*/
__packed struct usb_debug_descriptor {
    uint8_t  bLength;               /**<\brief Size of the descriptor, in bytes.*/
